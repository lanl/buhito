...
from .plotting_minerva import draw_ss, remove_bg
...
def mol_with_atom_index(
    ...
    """
    Return a copy of an RDKit molecule with atom-index annotations.

    This replaces minervachem.utils.misc.mol_with_atom_index.
    """
