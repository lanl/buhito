...
# Buhito graphlet transformer.
from .transformers import GraphletTransformer
...
def mol_with_atom_index(
    ...
    """
    Add atom indices to an RDKit molecule.
    ...
    index_start
        Offset added to each atom index.

    note
        If True, use RDKit's atomNote property.
        Otherwise use the atom-map number.

    Returns
    -------
    Chem.Mol
        Molecule with atom index annotations.
    """
